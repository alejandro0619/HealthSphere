 ...
 */
public class PatientInformation1 extends javax.swing.JFrame {

    /**
     * Creates new form PatientInformation
     */
    public PatientInformation1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        TabViews.setMinimumSize(new java.awt.Dimension(700, 700));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(91, 91, 91)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(labelPhone, javax.swing.GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE)
                    .addComponent(txtId)
        ...
        BgPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(BgPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(TabViews, javax.swing.GroupLayout.PREFERRED_SIZE, 903, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        BgPanel2Layout.setVerticalGroup(
            BgPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(TabViews, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );

        getContentPane().add(BgPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 900, -1));
    ...
    private void savePatientButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savePatientButtonActionPerformed
        ...
        /*try {
            Patient new_patient = new Patient(
                    ...
                    txtEmail.getText(),
                    SessionManager.getInstance().getCurrentUser(), (String) combBirthPlace.getSelectedItem(), (String) genreInput.getSelectedItem(), (String) insurance.getSelectedItem()
            );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientInformation1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientInformation1().setVisible(true);
            }
        });
    }
